...
from Game_outdated import LIKE_WHEN_ATTACKING, LIKE_WHEN_HELPING, MIN_ATTACK, MAX_ATTACK, TACTIC_LIST, VIT_CONSUME, MIN_COURAGE, MAX_COURAGE, MIN_PRODUCTIVITY, MAX_PRODUCTIVITY
from Game_outdated import LIKE_THRESHOLD, BE_LIKED_THRESHOLD, SPECTATOR_HELP
